...
class FirstCategory(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'category_firstcategory'
...
class SecondCategory(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'category_secondcategory'
...
class Color(models.Model):
    ...
    color_code = models.CharField(null=True, blank=True, help_text="color hx code", max_length=30)
...
class PopularTempKeyword(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'category_populartempkeyword'
